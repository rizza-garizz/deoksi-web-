  ...
  if (!globalThis.__DEOKSI_LOCAL_DB__) {
    ...
    globalThis.__DEOKSI_LOCAL_DB__ = {
      ...
      articles: [
        {
          id: 1,
          title: 'Cara Menjaga Skin Barrier Setelah Treatment',
          slug: 'cara-menjaga-skin-barrier-setelah-treatment',
          excerpt: 'Langkah sederhana agar hasil treatment lebih optimal dan kulit tetap nyaman.',
          content: 'Konten demo artikel untuk mode localhost tanpa database.',
        ...
        {
          id: 2,
          title: 'Promo Facial Brightening Minggu Ini',
          slug: 'promo-facial-brightening-minggu-ini',
          excerpt: 'Penawaran spesial untuk treatment brightening selama periode terbatas.',
          content: 'Konten promo demo untuk pengujian admin lokal.',
        ...
        {
          id: 3,
          title: 'Draft Edukasi Tentang Acne Series',
          slug: 'draft-edukasi-tentang-acne-series',
          excerpt: 'Draft konten internal untuk admin demo.',
          content: 'Draft artikel demo.',
          cover_image: '',
          category: 'tips',
          is_published: false,
          author: 'Deoksi Clinic',
